...
- In Ubuntu, `sudo apt-get update && sudo apt-get -qqy install build-essential clang-format bear cppcheck clang-tidy valgrind` SHALL be used to install all the required tools.
